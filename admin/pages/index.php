    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="produits.php"><i class="fa fa-edit fa-fw"></i> Vetements </a>
                        </li>
                       <li>
                            <a href="contact.php"><i class="fa fa-edit fa-fw"></i> Contact </a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
	  ...
	  <div class="panel-body">
                            <div class="dataTable_wrapper">
                              <font size="5px"> BIEVENUE à l'EPACE D'ADMINISTRATION</font>  <br> <br>
