...
if (isset($_POST['submit'])) {
    ...
    $titre = $_POST['titre'];
    $idG = $_POST['idG'];
    $req = "INSERT INTO categorie (idG,titre) VALUES ('$idG','$titre')";
    $res = mysql_query($req);
    if ($res) {
...
<body>
 ...
 <?php
            while ($row = mysql_fetch_array($genr)) 
			{ //parcourir automatique
                $id = $row['id']; 
				$idG = $row['idG'];
				$titre= $row['titre']; 
 ...
 <?php
	...
	<td><a href="<?php echo 'modifier_cat.php?id='.$id ?>"> Modifier</a></td>
	<td><a href="<?php echo 'supp_cat.php?id='.$id ?>">Supprimer</a></td>
                                        </tr>
										<?php
                }
                ?>
