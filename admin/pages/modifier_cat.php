...
$loisir = "";
$id=$_GET['id']; //recupération des variable par lien
$req="SELECT * FROM categorie where id=$id";
$ress= mysql_query($req);
$p=mysql_fetch_array($ress);
...
$mise="UPDATE categorie SET titre='$titre' WHERE id=".$id;

if($o=mysql_query($mise)){
            ...
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <form method="POST">
                                         ...
                                         <input type="text"  name="titre" value="<?php echo $p['titre'];  ?>">
