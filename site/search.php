...
<?php
    ...
    mysql_select_db("reve") or die(mysql_error());
    ...
    $query = $_GET['query']; 
        ...
        $raw_results = mysql_query("SELECT * FROM produits
            WHERE (`nom` LIKE '%".$query."%')") or die(mysql_error());
					 ...
					 <h4>$nom</h4>
					  ...
					  <div class='price-details'>
				       <div class='price-number'>
							<p><span class='rupees'>$prix </span></p>
					    </div>
					       		<div class='add-cart'>								
    	  ...
    	  <div class="content_bottom">
			...
			<?php	echo 
             "<div class='grid_1_of_4 images_1_of_4'>
					 <h4><a href='preview.php'>".$results['nom']."</a></h4>
					 
					  <img width ='350px' height='200px' src='files/$image'"." name='image'/>
					  </a>
					  <div class='price-details'>
				       <div class='price-number'>
							<p><span class='rupees'>".$results['prix']." </span></p>
					    </div>
					       		<div class='add-cart'>								
									 <h4> <a href='preview.php?id=$id'> afficher les details</a></h4>
							     </div>
